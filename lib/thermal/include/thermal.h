...
struct thermal_events_ops {
	...
	int (*threshold_added)(int tz_id, int temperature, int direction, void *arg);
	int (*threshold_deleted)(int tz_id, int temperature, int direction, void *arg);
	int (*threshold_flushed)(int tz_id, void *arg);
