...
static int handle_thermal_event(struct nl_msg *n, void *arg)
{
	...
	case THERMAL_GENL_EVENT_THRESHOLD_ADD:
		return ops->threshold_added(nla_get_u32(attrs[THERMAL_GENL_ATTR_TZ_ID]),
	...
	case THERMAL_GENL_EVENT_THRESHOLD_DELETE:
		return ops->threshold_deleted(nla_get_u32(attrs[THERMAL_GENL_ATTR_TZ_ID]),
					      nla_get_u32(attrs[THERMAL_GENL_ATTR_THRESHOLD_TEMP]),
					      nla_get_u32(attrs[THERMAL_GENL_ATTR_THRESHOLD_DIRECTION]), arg);

	case THERMAL_GENL_EVENT_THRESHOLD_FLUSH:
		return ops->threshold_flushed(nla_get_u32(attrs[THERMAL_GENL_ATTR_TZ_ID]), arg);
...
static void thermal_events_ops_init(struct thermal_events_ops *ops)
{
	...
	enabled_ops[THERMAL_GENL_EVENT_THRESHOLD_ADD]		= !!ops->threshold_added;
	enabled_ops[THERMAL_GENL_EVENT_THRESHOLD_DELETE]	= !!ops->threshold_deleted;
	enabled_ops[THERMAL_GENL_EVENT_THRESHOLD_FLUSH]		= !!ops->threshold_flushed;
